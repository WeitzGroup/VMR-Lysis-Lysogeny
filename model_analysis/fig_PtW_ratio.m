...
% figure is drawn
tmpfilename = 'figptw_ratio_label';
...
if (fp<=0)
  ...
  for j=1:nruns,
    ...
    for k=1:size(LHSample,1)
        ...
        theory.N=sqrt(info.K*info.m/(info.beta*info.phi));
...
set(tmph,'linewidth',3);
tmpt=text(10^5.5,10^2.8,'Knowles et al. (2016)');
